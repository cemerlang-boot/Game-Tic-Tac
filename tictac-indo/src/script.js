...
MYAPP.display = {  
  ...
  var message;
  if (isTwoPlayer) {
    message = "Pemain 1 : Pilih X atau O?"
  }
  else {
    message = "Pilih X atau O?";
  }
  MYAPP.timeOuts.push(
    setTimeout(function() {
  ...
  if (MYAPP.secondPlayer) {
    $('.player-one-turn p').text('Jalan Pemain 1!');
  }
  else {
    $('.player-one-turn p').text('Jalan Pemain 1!');
  }
  ...
  if (MYAPP.secondPlayer) {
    $('.player-two-turn p').text('Jalan Pemain 2!');
  }
  else {
    $('.player-two-turn p').text('Computer\'s jalan');
  }
  ...
  showWinMessage: function() {
    MYAPP.timeOuts.push(
      setTimeout(function() {
    $('.win-message').fadeIn(500).children('p').text("Pemain " + MYAPP.turn + " Menang ")
}, 1500));
},
  ...
  showScore: function() {
    if (MYAPP.secondPlayer) {
      $('.score-1').children('.name').text('Pemain 1'); 
      $('.score-2').children('.name').text('Pemain 2'); 
    }
    else {
      $('.score-1').children('.name').text('Pemain 1'); 
